...
describe("AthleteDirect", function()
  it("should direct-load-athlete", function()
    local setup = athlete_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-athlete", setup.live and "live" or "unit")
...
function athlete_direct_setup(mockres)
