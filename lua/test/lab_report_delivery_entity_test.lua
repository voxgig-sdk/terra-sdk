...
describe("LabReportDeliveryEntity", function()
  it("should create instance", function()
    ...
    local ent = testsdk:LabReportDelivery(nil)
  ...
  it("should run basic flow", function()
    ...
    local lab_report_delivery_ref01_data_raw = vs.items(helpers.to_map(
      vs.getpath(setup.data, "existing.lab_report_delivery")))
    local lab_report_delivery_ref01_data = nil
...
function lab_report_delivery_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/lab_report_delivery/LabReportDeliveryTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read lab_report_delivery test data: " .. entity_data_file)
  end
