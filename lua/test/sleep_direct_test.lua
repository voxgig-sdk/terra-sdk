...
describe("SleepDirect", function()
  it("should direct-load-sleep", function()
    local setup = sleep_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sleep", setup.live and "live" or "unit")
...
function sleep_direct_setup(mockres)
