...
describe("UserEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TERRA_TEST_USER_ENTID JSON to run live")
      return
    end
...
function user_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TERRA_TEST_USER_ENTID")
