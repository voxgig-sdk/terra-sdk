...
describe("LabReportFileEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:LabReportFile(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:LabReportFile(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TERRA_TEST_LAB_REPORT_FILE_ENTID JSON to run live")
      return
    end
