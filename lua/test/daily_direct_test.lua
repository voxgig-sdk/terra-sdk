...
describe("DailyDirect", function()
  it("should direct-load-daily", function()
    local setup = daily_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-daily", setup.live and "live" or "unit")
...
function daily_direct_setup(mockres)
