...
describe("MenstruationDirect", function()
  it("should direct-load-menstruation", function()
    local setup = menstruation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-menstruation", setup.live and "live" or "unit")
...
function menstruation_direct_setup(mockres)
