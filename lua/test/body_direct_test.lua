...
describe("BodyDirect", function()
  it("should direct-load-body", function()
    local setup = body_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-body", setup.live and "live" or "unit")
...
function body_direct_setup(mockres)
