...
describe("NutritionDirect", function()
  it("should direct-load-nutrition", function()
    local setup = nutrition_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nutrition", setup.live and "live" or "unit")
...
function nutrition_direct_setup(mockres)
