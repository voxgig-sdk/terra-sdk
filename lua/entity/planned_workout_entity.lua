...
local PlannedWorkoutEntity = {}
PlannedWorkoutEntity.__index = PlannedWorkoutEntity


function PlannedWorkoutEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlannedWorkoutEntity)
  self._name = "planned_workout"
  self._client = client
...
function PlannedWorkoutEntity:get_name()
  return self._name
end


function PlannedWorkoutEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlannedWorkoutEntity.new(self._client, opts)
end
...
function PlannedWorkoutEntity:mark_deleted()
  self._deleted = true
end


function PlannedWorkoutEntity:deleted()
  return true == self._deleted
end


function PlannedWorkoutEntity:data_set(args)
  if args ~= nil then
...
function PlannedWorkoutEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlannedWorkoutEntity:match_set(args)
  if args ~= nil then
...
function PlannedWorkoutEntity:match_get()
...
function PlannedWorkoutEntity:stream(action, args, callopts)
...
---@param reqmatch PlannedWorkoutLoadMatch
---@param ctrl? table
---@return PlannedWorkout
---@return string? err
function PlannedWorkoutEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PlannedWorkoutListMatch
---@param ctrl? table
---@return PlannedWorkout[]
---@return string? err
function PlannedWorkoutEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PlannedWorkoutUpdateData
---@param ctrl? table
---@return PlannedWorkout
---@return string? err
function PlannedWorkoutEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PlannedWorkoutEntity:_run_op(ctx, post_done)
  local utility = self._utility
