...
local LabReportFileEntity = {}
LabReportFileEntity.__index = LabReportFileEntity


function LabReportFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LabReportFileEntity)
  self._name = "lab_report_file"
  self._client = client
...
function LabReportFileEntity:get_name()
  return self._name
end


function LabReportFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LabReportFileEntity.new(self._client, opts)
end
...
function LabReportFileEntity:mark_deleted()
  self._deleted = true
end


function LabReportFileEntity:deleted()
  return true == self._deleted
end


function LabReportFileEntity:data_set(args)
  if args ~= nil then
...
function LabReportFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LabReportFileEntity:match_set(args)
  if args ~= nil then
...
function LabReportFileEntity:match_get()
...
function LabReportFileEntity:stream(action, args, callopts)
...
---@param reqmatch LabReportFileListMatch
---@param ctrl? table
---@return LabReportFile[]
---@return string? err
function LabReportFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function LabReportFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
