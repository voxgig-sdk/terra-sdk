...
local LabReportDeliveryEntity = {}
LabReportDeliveryEntity.__index = LabReportDeliveryEntity


function LabReportDeliveryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LabReportDeliveryEntity)
  self._name = "lab_report_delivery"
  self._client = client
...
function LabReportDeliveryEntity:get_name()
  return self._name
end


function LabReportDeliveryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LabReportDeliveryEntity.new(self._client, opts)
end
...
function LabReportDeliveryEntity:mark_deleted()
  self._deleted = true
end


function LabReportDeliveryEntity:deleted()
  return true == self._deleted
end


function LabReportDeliveryEntity:data_set(args)
  if args ~= nil then
...
function LabReportDeliveryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LabReportDeliveryEntity:match_set(args)
  if args ~= nil then
...
function LabReportDeliveryEntity:match_get()
...
function LabReportDeliveryEntity:stream(action, args, callopts)
...
---@param reqmatch LabReportDeliveryListMatch
---@param ctrl? table
---@return LabReportDelivery[]
---@return string? err
function LabReportDeliveryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function LabReportDeliveryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return LabReportDeliveryEntity
