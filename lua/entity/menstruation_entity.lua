...
local MenstruationEntity = {}
MenstruationEntity.__index = MenstruationEntity


function MenstruationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MenstruationEntity)
  self._name = "menstruation"
  self._client = client
...
function MenstruationEntity:get_name()
  return self._name
end


function MenstruationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MenstruationEntity.new(self._client, opts)
end
...
function MenstruationEntity:mark_deleted()
  self._deleted = true
end


function MenstruationEntity:deleted()
  return true == self._deleted
end


function MenstruationEntity:data_set(args)
  if args ~= nil then
...
function MenstruationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MenstruationEntity:match_set(args)
  if args ~= nil then
...
function MenstruationEntity:match_get()
...
function MenstruationEntity:stream(action, args, callopts)
...
---@param reqmatch MenstruationLoadMatch
---@param ctrl? table
---@return Menstruation
---@return string? err
function MenstruationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MenstruationEntity:_run_op(ctx, post_done)
  local utility = self._utility
