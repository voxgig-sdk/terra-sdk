...
function BodyEntity.new(client, entopts)
  entopts = entopts or {}
...
function BodyEntity:get_name()
  return self._name
end


function BodyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BodyEntity.new(self._client, opts)
end
...
function BodyEntity:mark_deleted()
  self._deleted = true
end


function BodyEntity:deleted()
  return true == self._deleted
end


function BodyEntity:data_set(args)
  if args ~= nil then
...
function BodyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BodyEntity:match_set(args)
  if args ~= nil then
...
function BodyEntity:stream(action, args, callopts)
...
---@param reqmatch BodyLoadMatch
---@param ctrl? table
---@return Body
---@return string? err
function BodyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BodyEntity:_run_op(ctx, post_done)
  local utility = self._utility
