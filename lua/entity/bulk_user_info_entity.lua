...
local BulkUserInfoEntity = {}
BulkUserInfoEntity.__index = BulkUserInfoEntity


function BulkUserInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BulkUserInfoEntity)
  self._name = "bulk_user_info"
  self._client = client
...
function BulkUserInfoEntity:get_name()
  return self._name
end


function BulkUserInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BulkUserInfoEntity.new(self._client, opts)
end
...
function BulkUserInfoEntity:mark_deleted()
  self._deleted = true
end


function BulkUserInfoEntity:deleted()
  return true == self._deleted
end


function BulkUserInfoEntity:data_set(args)
  if args ~= nil then
...
function BulkUserInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BulkUserInfoEntity:match_set(args)
  if args ~= nil then
...
function BulkUserInfoEntity:match_get()
...
function BulkUserInfoEntity:stream(action, args, callopts)
...
---@param reqdata BulkUserInfoCreateData
---@param ctrl? table
---@return BulkUserInfo
---@return string? err
function BulkUserInfoEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BulkUserInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
