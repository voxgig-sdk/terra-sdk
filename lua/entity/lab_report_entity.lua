...
local LabReportEntity = {}
LabReportEntity.__index = LabReportEntity


function LabReportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LabReportEntity)
  self._name = "lab_report"
  self._client = client
...
function LabReportEntity:get_name()
  return self._name
end


function LabReportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LabReportEntity.new(self._client, opts)
end
...
function LabReportEntity:mark_deleted()
  self._deleted = true
end


function LabReportEntity:deleted()
  return true == self._deleted
end


function LabReportEntity:data_set(args)
  if args ~= nil then
...
function LabReportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LabReportEntity:match_set(args)
  if args ~= nil then
...
function LabReportEntity:match_get()
...
function LabReportEntity:stream(action, args, callopts)
...
---@param reqmatch LabReportLoadMatch
---@param ctrl? table
---@return LabReport
---@return string? err
function LabReportEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch LabReportListMatch
---@param ctrl? table
---@return LabReport[]
---@return string? err
function LabReportEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata LabReportCreateData
---@param ctrl? table
---@return LabReport
---@return string? err
function LabReportEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch LabReportRemoveMatch
---@param ctrl? table
---@return LabReport
---@return string? err
function LabReportEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function LabReportEntity:_run_op(ctx, post_done)
  local utility = self._utility
