...
func TestUserEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set TERRA_TEST_USER_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func userBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("TERRA_TEST_USER_ENTID")
	...
	idmapResolved := core.ToMapAny(env["TERRA_TEST_USER_ENTID"])
