...
const testSeed = `map[string]any{"entity": map[string]any{"activity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "athlete": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "body": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bulk_user_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "daily": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "integration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lab_report": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lab_report_delivery": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lab_report_file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "menstruation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nutrition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "planned_workout": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sleep": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "workout": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
