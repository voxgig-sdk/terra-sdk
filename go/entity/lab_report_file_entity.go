...
type LabReportFileEntity struct {
	name    string
...
func NewLabReportFileEntity(client *core.TerraSDK, entopts map[string]any) *LabReportFileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LabReportFileEntity) GetName() string { return e.name }
...
func (e *LabReportFileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LabReportFileEntity) Deleted() bool {
	return e.deleted
}


func (e *LabReportFileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLabReportFileEntity(e.client, opts)
}

func (e *LabReportFileEntity) Data(args ...any) any {
...
func (e *LabReportFileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LabReportFile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LabReportFileEntity) DataTyped(data ...LabReportFile) LabReportFile {
	if len(data) > 0 {
		return typedFrom[LabReportFile](e.Data(asMap(data[0])))
	}
	return typedFrom[LabReportFile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LabReportFile (all fields
// optional at the wire level).
func (e *LabReportFileEntity) MatchTyped(match ...LabReportFile) LabReportFile {
	if len(match) > 0 {
		return typedFrom[LabReportFile](e.Match(asMap(match[0])))
	}
	return typedFrom[LabReportFile](e.Match())
}
...
func (e *LabReportFileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LabReportFileEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LabReportFileEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LabReportFileListMatch and returns []LabReportFile. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LabReportFileEntity) ListTyped(reqmatch LabReportFileListMatch, ctrl map[string]any) ([]LabReportFile, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LabReportFile](res), nil
}



func (e *LabReportFileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LabReportFileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LabReportFileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LabReportFileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
