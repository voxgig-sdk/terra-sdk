...
func NewBodyEntity(client *core.TerraSDK, entopts map[string]any) *BodyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BodyEntity) GetName() string { return e.name }
...
func (e *BodyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BodyEntity) Deleted() bool {
	return e.deleted
}


func (e *BodyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBodyEntity(e.client, opts)
}

func (e *BodyEntity) Data(args ...any) any {
...
func (e *BodyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Body; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BodyEntity) DataTyped(data ...Body) Body {
	if len(data) > 0 {
		return typedFrom[Body](e.Data(asMap(data[0])))
	}
	return typedFrom[Body](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Body (all fields
// optional at the wire level).
func (e *BodyEntity) MatchTyped(match ...Body) Body {
	if len(match) > 0 {
		return typedFrom[Body](e.Match(asMap(match[0])))
	}
	return typedFrom[Body](e.Match())
}
...
func (e *BodyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BodyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BodyLoadMatch and returns an Body. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BodyEntity) LoadTyped(reqmatch BodyLoadMatch, ctrl map[string]any) (Body, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Body{}, err
	}
	return typedFrom[Body](res), nil
}



func (e *BodyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BodyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BodyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BodyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BodyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
