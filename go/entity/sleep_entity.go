...
func (e *SleepEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SleepEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
