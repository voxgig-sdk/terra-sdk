...
func NewWorkoutEntity(client *core.TerraSDK, entopts map[string]any) *WorkoutEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkoutEntity) GetName() string { return e.name }
...
func (e *WorkoutEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorkoutEntity) Deleted() bool {
	return e.deleted
}


func (e *WorkoutEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorkoutEntity(e.client, opts)
}

func (e *WorkoutEntity) Data(args ...any) any {
...
func (e *WorkoutEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Workout; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorkoutEntity) DataTyped(data ...Workout) Workout {
	if len(data) > 0 {
		return typedFrom[Workout](e.Data(asMap(data[0])))
	}
	return typedFrom[Workout](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Workout (all fields
// optional at the wire level).
func (e *WorkoutEntity) MatchTyped(match ...Workout) Workout {
	if len(match) > 0 {
		return typedFrom[Workout](e.Match(asMap(match[0])))
	}
	return typedFrom[Workout](e.Match())
}
...
func (e *WorkoutEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorkoutEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorkoutLoadMatch and returns an Workout. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WorkoutEntity) LoadTyped(reqmatch WorkoutLoadMatch, ctrl map[string]any) (Workout, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Workout{}, err
	}
	return typedFrom[Workout](res), nil
}




func (e *WorkoutEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WorkoutListMatch and returns []Workout. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WorkoutEntity) ListTyped(reqmatch WorkoutListMatch, ctrl map[string]any) ([]Workout, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Workout](res), nil
}




func (e *WorkoutEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// WorkoutCreateData and returns an Workout. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *WorkoutEntity) CreateTyped(reqdata WorkoutCreateData, ctrl map[string]any) (Workout, error) {
...
func (e *WorkoutEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *WorkoutEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// WorkoutRemoveMatch and returns an Workout. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *WorkoutEntity) RemoveTyped(reqmatch WorkoutRemoveMatch, ctrl map[string]any) (Workout, error) {
...
func (e *WorkoutEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
