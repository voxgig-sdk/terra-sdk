...
func NewAuthenticationEntity(client *core.TerraSDK, entopts map[string]any) *AuthenticationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthenticationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AuthenticationRemoveMatch and returns an Authentication. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AuthenticationEntity) RemoveTyped(reqmatch AuthenticationRemoveMatch, ctrl map[string]any) (Authentication, error) {
