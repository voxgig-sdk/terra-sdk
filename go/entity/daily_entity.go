...
func NewDailyEntity(client *core.TerraSDK, entopts map[string]any) *DailyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DailyEntity) GetName() string { return e.name }
...
func (e *DailyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DailyEntity) Deleted() bool {
	return e.deleted
}


func (e *DailyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDailyEntity(e.client, opts)
}

func (e *DailyEntity) Data(args ...any) any {
...
func (e *DailyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Daily; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DailyEntity) DataTyped(data ...Daily) Daily {
	if len(data) > 0 {
		return typedFrom[Daily](e.Data(asMap(data[0])))
	}
	return typedFrom[Daily](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Daily (all fields
// optional at the wire level).
func (e *DailyEntity) MatchTyped(match ...Daily) Daily {
	if len(match) > 0 {
		return typedFrom[Daily](e.Match(asMap(match[0])))
	}
	return typedFrom[Daily](e.Match())
}
...
func (e *DailyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DailyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DailyLoadMatch and returns an Daily. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DailyEntity) LoadTyped(reqmatch DailyLoadMatch, ctrl map[string]any) (Daily, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Daily{}, err
	}
	return typedFrom[Daily](res), nil
}



func (e *DailyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DailyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DailyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DailyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DailyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
