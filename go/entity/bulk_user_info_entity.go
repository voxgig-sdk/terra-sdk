...
type BulkUserInfoEntity struct {
	name    string
...
func NewBulkUserInfoEntity(client *core.TerraSDK, entopts map[string]any) *BulkUserInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BulkUserInfoEntity) GetName() string { return e.name }
...
func (e *BulkUserInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BulkUserInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *BulkUserInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBulkUserInfoEntity(e.client, opts)
}

func (e *BulkUserInfoEntity) Data(args ...any) any {
...
func (e *BulkUserInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BulkUserInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BulkUserInfoEntity) DataTyped(data ...BulkUserInfo) BulkUserInfo {
	if len(data) > 0 {
		return typedFrom[BulkUserInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[BulkUserInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BulkUserInfo (all fields
// optional at the wire level).
func (e *BulkUserInfoEntity) MatchTyped(match ...BulkUserInfo) BulkUserInfo {
	if len(match) > 0 {
		return typedFrom[BulkUserInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[BulkUserInfo](e.Match())
}
...
func (e *BulkUserInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BulkUserInfoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BulkUserInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BulkUserInfoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BulkUserInfoCreateData and returns an BulkUserInfo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BulkUserInfoEntity) CreateTyped(reqdata BulkUserInfoCreateData, ctrl map[string]any) (BulkUserInfo, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BulkUserInfo{}, err
	}
	return typedFrom[BulkUserInfo](res), nil
}



func (e *BulkUserInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BulkUserInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BulkUserInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
