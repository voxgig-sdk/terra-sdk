...
type MenstruationEntity struct {
	name    string
...
func NewMenstruationEntity(client *core.TerraSDK, entopts map[string]any) *MenstruationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MenstruationEntity) GetName() string { return e.name }
...
func (e *MenstruationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MenstruationEntity) Deleted() bool {
	return e.deleted
}


func (e *MenstruationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMenstruationEntity(e.client, opts)
}

func (e *MenstruationEntity) Data(args ...any) any {
...
func (e *MenstruationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Menstruation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MenstruationEntity) DataTyped(data ...Menstruation) Menstruation {
	if len(data) > 0 {
		return typedFrom[Menstruation](e.Data(asMap(data[0])))
	}
	return typedFrom[Menstruation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Menstruation (all fields
// optional at the wire level).
func (e *MenstruationEntity) MatchTyped(match ...Menstruation) Menstruation {
	if len(match) > 0 {
		return typedFrom[Menstruation](e.Match(asMap(match[0])))
	}
	return typedFrom[Menstruation](e.Match())
}
...
func (e *MenstruationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MenstruationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MenstruationLoadMatch and returns an Menstruation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MenstruationEntity) LoadTyped(reqmatch MenstruationLoadMatch, ctrl map[string]any) (Menstruation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Menstruation{}, err
	}
	return typedFrom[Menstruation](res), nil
}



func (e *MenstruationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MenstruationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MenstruationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MenstruationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MenstruationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
