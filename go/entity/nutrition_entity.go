...
func NewNutritionEntity(client *core.TerraSDK, entopts map[string]any) *NutritionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NutritionEntity) GetName() string { return e.name }
...
func (e *NutritionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NutritionEntity) Deleted() bool {
	return e.deleted
}


func (e *NutritionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNutritionEntity(e.client, opts)
}

func (e *NutritionEntity) Data(args ...any) any {
...
func (e *NutritionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nutrition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NutritionEntity) DataTyped(data ...Nutrition) Nutrition {
	if len(data) > 0 {
		return typedFrom[Nutrition](e.Data(asMap(data[0])))
	}
	return typedFrom[Nutrition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nutrition (all fields
// optional at the wire level).
func (e *NutritionEntity) MatchTyped(match ...Nutrition) Nutrition {
	if len(match) > 0 {
		return typedFrom[Nutrition](e.Match(asMap(match[0])))
	}
	return typedFrom[Nutrition](e.Match())
}
...
func (e *NutritionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NutritionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NutritionLoadMatch and returns an Nutrition. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NutritionEntity) LoadTyped(reqmatch NutritionLoadMatch, ctrl map[string]any) (Nutrition, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Nutrition{}, err
	}
	return typedFrom[Nutrition](res), nil
}



func (e *NutritionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NutritionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NutritionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NutritionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NutritionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
