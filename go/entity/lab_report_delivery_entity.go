...
type LabReportDeliveryEntity struct {
	name    string
...
func NewLabReportDeliveryEntity(client *core.TerraSDK, entopts map[string]any) *LabReportDeliveryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LabReportDeliveryEntity) GetName() string { return e.name }
...
func (e *LabReportDeliveryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LabReportDeliveryEntity) Deleted() bool {
	return e.deleted
}


func (e *LabReportDeliveryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLabReportDeliveryEntity(e.client, opts)
}

func (e *LabReportDeliveryEntity) Data(args ...any) any {
...
func (e *LabReportDeliveryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LabReportDelivery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LabReportDeliveryEntity) DataTyped(data ...LabReportDelivery) LabReportDelivery {
	if len(data) > 0 {
		return typedFrom[LabReportDelivery](e.Data(asMap(data[0])))
	}
	return typedFrom[LabReportDelivery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LabReportDelivery (all fields
// optional at the wire level).
func (e *LabReportDeliveryEntity) MatchTyped(match ...LabReportDelivery) LabReportDelivery {
	if len(match) > 0 {
		return typedFrom[LabReportDelivery](e.Match(asMap(match[0])))
	}
	return typedFrom[LabReportDelivery](e.Match())
}
...
func (e *LabReportDeliveryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LabReportDeliveryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LabReportDeliveryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LabReportDeliveryListMatch and returns []LabReportDelivery. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LabReportDeliveryEntity) ListTyped(reqmatch LabReportDeliveryListMatch, ctrl map[string]any) ([]LabReportDelivery, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LabReportDelivery](res), nil
}



func (e *LabReportDeliveryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LabReportDeliveryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LabReportDeliveryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LabReportDeliveryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
