...
func NewAthleteEntity(client *core.TerraSDK, entopts map[string]any) *AthleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AthleteEntity) GetName() string { return e.name }
...
func (e *AthleteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AthleteEntity) Deleted() bool {
	return e.deleted
}


func (e *AthleteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAthleteEntity(e.client, opts)
}

func (e *AthleteEntity) Data(args ...any) any {
...
func (e *AthleteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Athlete; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AthleteEntity) DataTyped(data ...Athlete) Athlete {
	if len(data) > 0 {
		return typedFrom[Athlete](e.Data(asMap(data[0])))
	}
	return typedFrom[Athlete](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Athlete (all fields
// optional at the wire level).
func (e *AthleteEntity) MatchTyped(match ...Athlete) Athlete {
	if len(match) > 0 {
		return typedFrom[Athlete](e.Match(asMap(match[0])))
	}
	return typedFrom[Athlete](e.Match())
}
...
func (e *AthleteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AthleteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AthleteLoadMatch and returns an Athlete. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AthleteEntity) LoadTyped(reqmatch AthleteLoadMatch, ctrl map[string]any) (Athlete, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Athlete{}, err
	}
	return typedFrom[Athlete](res), nil
}



func (e *AthleteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AthleteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AthleteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AthleteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AthleteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
