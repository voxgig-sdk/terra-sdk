...
|---|---|---|
| `js/` | @voxgig-sdk/terra-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/terra | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/terra-js \
      --repository voxgig-sdk/terra-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/terra-js` shows it, and
`npm trust revoke @voxgig-sdk/terra-js --id=<id>` removes it.
