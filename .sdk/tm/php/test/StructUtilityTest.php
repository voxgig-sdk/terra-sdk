...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TerraOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TerraOmni::structfix($now, Struct::undef()))
                        !== json_encode(TerraOmni::structfix($val, Struct::undef()))) {
