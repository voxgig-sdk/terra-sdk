...
// Terra SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TerraMakeRequest
{
    public static function call(TerraContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TerraResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TerraResponse($fetched);
        } else {
