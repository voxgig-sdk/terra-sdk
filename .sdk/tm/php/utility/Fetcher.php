...
class TerraFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TerraSDK/1.0)';
    ...
    public static function call(TerraContext $ctx, string $fullurl, array $fetchdef): array
    {
