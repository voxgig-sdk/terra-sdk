...
class TerraClienttrackFeature extends TerraBaseFeature
{
    ...
    public function PostConstruct(TerraContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Terra-SDK';
