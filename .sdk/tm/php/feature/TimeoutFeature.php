...
class TerraTimeoutFeature extends TerraBaseFeature
{
    ...
    private function _with_timeout(TerraContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TerraContext $_ctx, float $ms): void
    {
        $client = $this->client;
