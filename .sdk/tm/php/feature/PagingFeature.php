...
class TerraPagingFeature extends TerraBaseFeature
{
    ...
    private function _graphql_pre_request(TerraContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(TerraContext $ctx): bool
    {
