...
class TerraProxyFeature extends TerraBaseFeature
{
    ...
    public function init(TerraContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TerraContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
