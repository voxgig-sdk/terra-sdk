...
class TerraTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TerraTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TerraTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TerraTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
