...
class TerraTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TerraTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TerraTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TerraTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
