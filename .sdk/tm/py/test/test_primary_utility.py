...
_runner = makeRunner(TEST_JSON_FILE, TerraSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TerraSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TerraSDK.test(None, setup.get('a') or {})
