...
const { AthleteEntity } = require('./entity/AthleteEntity')
const { AuthenticationEntity } = require('./entity/AuthenticationEntity')
const { BodyEntity } = require('./entity/BodyEntity')
const { BulkUserInfoEntity } = require('./entity/BulkUserInfoEntity')
const { DailyEntity } = require('./entity/DailyEntity')
...
const { SleepEntity } = require('./entity/SleepEntity')
const { UserEntity } = require('./entity/UserEntity')
const { WorkoutEntity } = require('./entity/WorkoutEntity')
...
const { TerraEntityBase } = require('./TerraEntityBase')
...
class TerraSDK {
  ...
  async graphql(query, variables, ctrl) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err = new Error('TerraSDK: graphql: ' +
