...
class NutritionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NutritionEntity($this->_client, $opts);
    }

    /**
     * @param Nutrition|array $args Nutrition data (assoc-array) to store.
     */
    ...
    /**
     * @return Nutrition|array The current Nutrition data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Nutrition fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Nutrition fields).
     */
    ...
    /**
     * Load a single Nutrition.
     *
     * @param NutritionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NutritionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nutrition|array The loaded Nutrition as an assoc-array at the
