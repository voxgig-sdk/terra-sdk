...
// Terra SDK Authentication entity
...
class AuthenticationEntity
{
    ...
    /**
     * Remove an Authentication matching the given criteria.
     *
     * @param AuthenticationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AuthenticationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Authentication|array The removed Authentication as an assoc-array at the
     *   SDK boundary; throws TerraError on failure (item-5 convention).
     */
