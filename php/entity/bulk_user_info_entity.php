...
class BulkUserInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BulkUserInfoEntity($this->_client, $opts);
    }

    /**
     * @param BulkUserInfo|array $args BulkUserInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return BulkUserInfo|array The current BulkUserInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BulkUserInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BulkUserInfo fields).
     */
    ...
    /**
     * Create a new BulkUserInfo.
     *
     * @param BulkUserInfoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkUserInfoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUserInfo|array The created BulkUserInfo as an assoc-array at the
