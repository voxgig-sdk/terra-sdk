...
class DailyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DailyEntity($this->_client, $opts);
    }

    /**
     * @param Daily|array $args Daily data (assoc-array) to store.
     */
    ...
    /**
     * @return Daily|array The current Daily data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Daily fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Daily fields).
     */
     ...
     * Load a single Daily.
     *
     * @param DailyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DailyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Daily|array The loaded Daily as an assoc-array at the
