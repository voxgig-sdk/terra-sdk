...
class MenstruationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MenstruationEntity($this->_client, $opts);
    }

    /**
     * @param Menstruation|array $args Menstruation data (assoc-array) to store.
     */
    ...
    /**
     * @return Menstruation|array The current Menstruation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Menstruation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Menstruation fields).
     */
    ...
    /**
     * Load a single Menstruation.
     *
     * @param MenstruationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MenstruationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Menstruation|array The loaded Menstruation as an assoc-array at the
