...
class SleepEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SleepEntity($this->_client, $opts);
    }

    /**
     * @param Sleep|array $args Sleep data (assoc-array) to store.
     */
    ...
    /**
     * @return Sleep|array The current Sleep data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sleep fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sleep fields).
     */
     ...
     * Load a single Sleep.
     *
     * @param SleepLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SleepLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sleep|array The loaded Sleep as an assoc-array at the
