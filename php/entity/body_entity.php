...
class BodyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BodyEntity($this->_client, $opts);
    }

    /**
     * @param Body|array $args Body data (assoc-array) to store.
     */
    ...
    /**
     * @return Body|array The current Body data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Body fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Body fields).
     */
     ...
     * Load a single Body.
     *
     * @param BodyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BodyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Body|array The loaded Body as an assoc-array at the
