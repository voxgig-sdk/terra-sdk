...
class WorkoutEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkoutEntity($this->_client, $opts);
    }

    /**
     * @param Workout|array $args Workout data (assoc-array) to store.
     */
    ...
    /**
     * @return Workout|array The current Workout data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Workout fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Workout fields).
     */
     ...
     *
     * @param WorkoutLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkoutLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workout|array The loaded Workout as an assoc-array at the
    ...
    /**
     * List Workout items matching the given filter.
     *
     * @param WorkoutListMatch|array|null $reqmatch Match filter (any subset
     *   of Workout fields) as an assoc-array; WorkoutListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workout[]|array A list of Workout items as assoc-arrays at
     ...
     *
     * @param WorkoutCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WorkoutCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workout|array The created Workout as an assoc-array at the
     *   SDK boundary; throws TerraError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Workout matching the given criteria.
     *
     * @param WorkoutRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; WorkoutRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workout|array The removed Workout as an assoc-array at the
     *   SDK boundary; throws TerraError on failure (item-5 convention).
     */
