...
class AthleteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AthleteEntity($this->_client, $opts);
    }

    /**
     * @param Athlete|array $args Athlete data (assoc-array) to store.
     */
    ...
    /**
     * @return Athlete|array The current Athlete data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Athlete fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Athlete fields).
     */
    ...
    /**
     * Load a single Athlete.
     *
     * @param AthleteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AthleteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Athlete|array The loaded Athlete as an assoc-array at the
