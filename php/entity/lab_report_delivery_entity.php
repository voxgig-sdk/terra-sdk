...
// Terra SDK LabReportDelivery entity
...
class LabReportDeliveryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "lab_report_delivery";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new LabReportDeliveryEntity($this->_client, $opts);
    }

    /**
     * @param LabReportDelivery|array $args LabReportDelivery data (assoc-array) to store.
     */
    ...
    /**
     * @return LabReportDelivery|array The current LabReportDelivery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LabReportDelivery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LabReportDelivery fields).
     */
    ...
    /**
     * List LabReportDelivery items matching the given filter.
     *
     * @param LabReportDeliveryListMatch|array|null $reqmatch Match filter (any subset
     *   of LabReportDelivery fields) as an assoc-array; LabReportDeliveryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LabReportDelivery[]|array A list of LabReportDelivery items as assoc-arrays at
