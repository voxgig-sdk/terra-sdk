...
// Terra SDK PlannedWorkout entity
...
class PlannedWorkoutEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlannedWorkoutEntity($this->_client, $opts);
    }

    /**
     * @param PlannedWorkout|array $args PlannedWorkout data (assoc-array) to store.
     */
    ...
    /**
     * @return PlannedWorkout|array The current PlannedWorkout data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PlannedWorkout fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PlannedWorkout fields).
     */
    ...
    /**
     * Load a single PlannedWorkout.
     *
     * @param PlannedWorkoutLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PlannedWorkoutLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PlannedWorkout|array The loaded PlannedWorkout as an assoc-array at the
    ...
    /**
     * List PlannedWorkout items matching the given filter.
     *
     * @param PlannedWorkoutListMatch|array|null $reqmatch Match filter (any subset
     *   of PlannedWorkout fields) as an assoc-array; PlannedWorkoutListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PlannedWorkout[]|array A list of PlannedWorkout items as assoc-arrays at
    ...
    /**
     * Update an existing PlannedWorkout.
     *
     * @param PlannedWorkoutUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PlannedWorkoutUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PlannedWorkout|array The updated PlannedWorkout as an assoc-array at the
     *   SDK boundary; throws TerraError on failure (item-5 convention).
     */
