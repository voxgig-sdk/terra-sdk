...
// Terra SDK LabReportFile entity
...
class LabReportFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LabReportFileEntity($this->_client, $opts);
    }

    /**
     * @param LabReportFile|array $args LabReportFile data (assoc-array) to store.
     */
    ...
    /**
     * @return LabReportFile|array The current LabReportFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LabReportFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LabReportFile fields).
     */
    ...
    /**
     * List LabReportFile items matching the given filter.
     *
     * @param LabReportFileListMatch|array|null $reqmatch Match filter (any subset
     *   of LabReportFile fields) as an assoc-array; LabReportFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LabReportFile[]|array A list of LabReportFile items as assoc-arrays at
