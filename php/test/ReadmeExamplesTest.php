...
// Terra SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TerraSDK::test)
...
{
    private const SDK_CLASS = 'TerraSDK';
    ...
    private const SDK_BASE = 'terra_sdk';
