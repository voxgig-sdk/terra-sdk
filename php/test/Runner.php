...
class TerraTestRunner
{
    ...
    {
        $live = self::getenv('TERRA_TEST_LIVE');
        $override = self::getenv('TERRA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TERRA_TEST_EXPLAIN');
...
class_alias('TerraTestRunner', 'Runner');
class_alias('TerraHelpers', 'Helpers');
