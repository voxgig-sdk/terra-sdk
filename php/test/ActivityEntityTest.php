...
class ActivityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TERRA_TEST_ACTIVITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function activity_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TERRA_TEST_ACTIVITY_ENTID");
