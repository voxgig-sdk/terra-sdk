...
class IntegrationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TERRA_TEST_INTEGRATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function integration_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TERRA_TEST_INTEGRATION_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["TERRA_TEST_INTEGRATION_ENTID"]);
