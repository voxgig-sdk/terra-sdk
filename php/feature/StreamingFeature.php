...
class TerraStreamingFeature extends TerraBaseFeature
{
    ...
    private function _iterate(TerraResult $result): \Generator
    {
    ...
    private function _streamable(TerraContext $ctx): bool
    {
