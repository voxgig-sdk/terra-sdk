...
class TerraRbacFeature extends TerraBaseFeature
{
    ...
    private function _required(TerraContext $ctx): ?string
    {
    ...
    private function _reject(TerraContext $ctx, string $required): void
    {
    ...
    private function _track(TerraContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
