...
// Terra SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TerraTestFeature extends TerraBaseFeature
{
    ...
    public function init(TerraContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TerraContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TerraContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TerraContext $ctx, $op, $args): array
    {
