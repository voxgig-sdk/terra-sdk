...
class TerraCacheFeature extends TerraBaseFeature
{
    ...
    private function _through(TerraContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
