...
class TerraRatelimitFeature extends TerraBaseFeature
{
    ...
    private function _acquire(TerraContext $ctx): void
    {
    ...
    private function _track(TerraContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
