...
describe('SleepDirect', async () => {
  ...
  test('direct-load-sleep', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-sleep', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TERRA_TEST_SLEEP_ENTID']
