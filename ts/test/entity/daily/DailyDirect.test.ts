...
describe('DailyDirect', async () => {
  ...
  test('direct-load-daily', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-daily', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TERRA_TEST_DAILY_ENTID']
