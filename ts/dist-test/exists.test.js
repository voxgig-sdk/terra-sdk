...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // TerraSDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        ...
        (0, node_assert_1.equal)(testsdk instanceof __1.TerraSDK, true, 'TerraSDK.test() must return a client synchronously');
    });
});
