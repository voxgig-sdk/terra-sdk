...
(0, node_test_1.describe)('LabReportDeliveryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-lab_report_delivery', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-lab_report_delivery', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["lab_report_delivery01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TERRA_TEST_LAB_REPORT_DELIVERY_ENTID'];
...
//# sourceMappingURL=LabReportDeliveryDirect.test.js.map