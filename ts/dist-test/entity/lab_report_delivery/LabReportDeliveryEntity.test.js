...
(0, node_test_1.describe)('LabReportDeliveryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'lab_report_delivery.' + op, live))
                return;
        }
        ...
        const lab_report_delivery_ref01_list = await lab_report_delivery_ref01_ent.list(lab_report_delivery_ref01_match);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TERRA_TEST_LAB_REPORT_DELIVERY_ENTID'];
