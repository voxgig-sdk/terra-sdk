...
(0, node_test_1.describe)('AthleteEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'athlete.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/athlete/AthleteTestData.json');
    ...
    let idmap = transform(['athlete01', 'athlete02', 'athlete03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TERRA_TEST_ATHLETE_ENTID'];
...
//# sourceMappingURL=AthleteEntity.test.js.map