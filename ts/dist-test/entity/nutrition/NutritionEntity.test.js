...
(0, node_test_1.describe)('NutritionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'nutrition.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != nutrition_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/nutrition/NutritionTestData.json');
    ...
    let idmap = transform(['nutrition01', 'nutrition02', 'nutrition03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TERRA_TEST_NUTRITION_ENTID'];
...
//# sourceMappingURL=NutritionEntity.test.js.map