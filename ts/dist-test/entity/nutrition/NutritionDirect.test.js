...
(0, node_test_1.describe)('NutritionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-nutrition', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-nutrition', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TERRA_TEST_NUTRITION_ENTID'];
...
//# sourceMappingURL=NutritionDirect.test.js.map