...
(0, node_test_1.describe)('MenstruationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'menstruation.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != menstruation_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/menstruation/MenstruationTestData.json');
    ...
    let idmap = transform(['menstruation01', 'menstruation02', 'menstruation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TERRA_TEST_MENSTRUATION_ENTID'];
...
//# sourceMappingURL=MenstruationEntity.test.js.map