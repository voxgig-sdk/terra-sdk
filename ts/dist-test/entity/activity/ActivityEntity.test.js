...
(0, node_test_1.describe)('ActivityEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TERRA_TEST_ACTIVITY_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != activity_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TERRA_TEST_ACTIVITY_ENTID'];
    ...
    idmap = env['TERRA_TEST_ACTIVITY_ENTID'];
