...
(0, node_test_1.describe)('BodyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-body', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-body', setup.live))
            return;
...
//# sourceMappingURL=BodyDirect.test.js.map