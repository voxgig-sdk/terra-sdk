...
(0, node_test_1.describe)('WorkoutDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-workout', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-workout', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-workout', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-workout', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TERRA_TEST_WORKOUT_ENTID'];
...
//# sourceMappingURL=WorkoutDirect.test.js.map