...
(0, node_test_1.describe)('SleepDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sleep', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sleep', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TERRA_TEST_SLEEP_ENTID'];
...
//# sourceMappingURL=SleepDirect.test.js.map