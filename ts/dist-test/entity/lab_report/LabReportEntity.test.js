...
(0, node_test_1.describe)('LabReportEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'lab_report.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != lab_report_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(lab_report_ref01_list, { id: lab_report_ref01_data.id })));
        // LOAD
        ...
        (0, node_assert_1.default)(lab_report_ref01_data_dt0.id === lab_report_ref01_data.id);
        // REMOVE
        const lab_report_ref01_match_rm0 = { id: lab_report_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(lab_report_ref01_list_rt0, { id: lab_report_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/lab_report/LabReportTestData.json');
    ...
    let idmap = transform(['lab_report01', 'lab_report02', 'lab_report03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TERRA_TEST_LAB_REPORT_ENTID'];
...
//# sourceMappingURL=LabReportEntity.test.js.map