...
(0, node_test_1.describe)('LabReportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-lab_report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-lab_report', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-lab_report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-lab_report', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TERRA_TEST_LAB_REPORT_ENTID'];
...
//# sourceMappingURL=LabReportDirect.test.js.map