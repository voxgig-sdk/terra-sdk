...
class TerraSDK {
  ...
  async direct(fetchargs?: any) {
    if (!this._options.allow.op.includes('direct')) {
      return {
        ok: false,
        err: new Error('TerraSDK: direct: operation not allowed by' +
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (!options.allow.op.includes('graphql')) {
      return {
        ok: false,
        err: new Error('TerraSDK: graphql: operation not allowed by' +
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('TerraSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Body(entopts?: Record<string, any>) {
    const self = this
    return new BodyEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  BulkUserInfo(entopts?: Record<string, any>) {
    const self = this
    return new BulkUserInfoEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Daily(entopts?: Record<string, any>) {
    const self = this
    return new DailyEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  LabReport(entopts?: Record<string, any>) {
    const self = this
    return new LabReportEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  LabReportDelivery(entopts?: Record<string, any>) {
    const self = this
    return new LabReportDeliveryEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Menstruation(entopts?: Record<string, any>) {
    const self = this
    return new MenstruationEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Nutrition(entopts?: Record<string, any>) {
    const self = this
    return new NutritionEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PlannedWorkout(entopts?: Record<string, any>) {
    const self = this
    return new PlannedWorkoutEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Sleep(entopts?: Record<string, any>) {
    const self = this
    return new SleepEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Workout(entopts?: Record<string, any>) {
    const self = this
    return new WorkoutEntity(self, entopts)
  }
