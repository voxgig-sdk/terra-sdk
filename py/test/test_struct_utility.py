...
from terra_sdk.utility.voxgig_struct.voxgig_struct import (
...
runner = makeRunner(STRUCT_TEST_JSON, TerraSDK.test(None, None))
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from terra_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
