...
from terra_sdk.core.response import TerraResponse
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TerraSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TerraSDK.test(None, None)
        ...
        class TestInitFeature(TerraBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TerraBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TerraSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TerraSDK.test(None, setup_opts)
