# Terra SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TerraSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TerraSDK(...) and TerraSDK.test(...) become
#      TerraSDK.test({"entity": {...}}) seeding one mock record (id "test01")
