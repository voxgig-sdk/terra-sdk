...
class LabReportDeliveryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LabReportDeliveryEntity(self._client, opts)
    ...
    def data_get(self) -> LabReportDelivery:
    ...
    def match_get(self) -> LabReportDelivery:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LabReportDelivery]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LabReportDelivery().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
