...
class BulkUserInfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BulkUserInfoEntity(self._client, opts)
    ...
    def data_get(self) -> BulkUserInfo:
    ...
    def match_get(self) -> BulkUserInfo:
    ...
    def create(self, reqdata: BulkUserInfoCreateData, ctrl=None) -> BulkUserInfo:
        utility = self._utility
