...
class MenstruationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MenstruationEntity(self._client, opts)
    ...
    def data_get(self) -> Menstruation:
    ...
    def match_get(self) -> Menstruation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Menstruation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Menstruation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
