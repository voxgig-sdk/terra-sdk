...
class LabReportFileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LabReportFileEntity(self._client, opts)
    ...
    def data_get(self) -> LabReportFile:
    ...
    def match_get(self) -> LabReportFile:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LabReportFile]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LabReportFile().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
