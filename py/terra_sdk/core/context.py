...
from terra_sdk.core.helpers import get_ctx_prop, to_map
...
class TerraContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TerraResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TerraError(code, msg, self)
